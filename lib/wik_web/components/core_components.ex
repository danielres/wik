defmodule WikWeb.CoreComponents do
  @moduledoc """
  ...
  def header(assigns) do
    ~H"""
    <header class={["mt-16", "mb-6", @actions != [] && "flex items-center justify-between gap-6"]}>
      <div>
        <h1 class="text-3xl">
          {render_slot(@inner_block)}
        </h1>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WikWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WikWeb.Gettext, "errors", msg, opts)
    end
  end
