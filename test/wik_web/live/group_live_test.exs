# defmodule WikWeb.GroupLiveTest do
#   use WikWeb.ConnCase

#   import Phoenix.LiveViewTest
#   import Wik.GroupsFixtures

#   @create_attrs %{id: "some id", name: "some name", owner: "some owner", slug: "some slug"}
#   @update_attrs %{id: "some updated id", name: "some updated name", owner: "some updated owner", slug: "some updated slug"}
#   @invalid_attrs %{id: nil, name: nil, owner: nil, slug: nil}
